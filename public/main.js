...
document.addEventListener('init', function (event) {
    ...
    if (page.matches("#home")) {
        ...
        console.log(autoData[0] + " - " + autoData[1])
        console.log("-------------END----------------");
        ...
        let autoConfig = {
            ...
            data: {
                datasets: [{
                    data: [
                        autoData[0]/matches.length, autoData[1]/matches.length
                    ],
        ...
        if (matches[0] && matches[0].endGameSuccess !== undefined) {
            ...
            endGameLabels = ['None', 'Parked', 'Platform', 'Level 2', 'Level 3', 'Participated in teammate\'s climb'];
